...
export function FeedDeleteDialog({
  ...
  const destroyFeed = useMutation({
    mutationFn: async (id: string) => {
      await feedServices.destroy(id)
    },
    onSuccess: () => {
      ...
      toast.success('Feed excluído com sucesso!')
      setOpen(false)
    },
    onError: () => {
      toast.error('Erro ao excluir feed!')
    },
  })
